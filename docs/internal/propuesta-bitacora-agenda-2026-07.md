...
> | **P-AYUDA-1** | Bitácora no tenía ninguna entrada en la Ayuda/FAQ de la app ni del portal, ni en el system prompt del asistente de IA — pese a estar en producción desde F1.1. | ✅ **CERRADO 2026-08-26** junto con la tarea equivalente de Markdown (M5) — 7 preguntas nuevas en las 2 FAQ + bullets en `aiSupportPrompt.js`. |
>
