...
> requiere un release que todavía no se cortó. **Sigue F2.3** (selección múltiple en los visores +
> pantalla de revisión del lote en el portal, que es quien consume el borrador).
