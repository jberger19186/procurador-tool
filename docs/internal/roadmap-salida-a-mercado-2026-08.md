...
```
  ...
  (lo que se muestra y se vende)           │  AZ — Azure Trusted Signing     │
    ...
    1.6 Demo reproducible en landing   🔄  (D1-D3/D5/D6 ✅ implementado, falta desplegar D6 y hacer D4)
              │
              ▼
...
### 1.6 — Demo reproducible del producto en la landing ⏳ D1-D3/D5/D6 IMPLEMENTADOS, falta desplegar D6 y hacer D4
...
| **Fases** | **6 (D1–D6)** · **D1 ✅ · D2 ✅ · D3 ✅** (32/36 pasos capturados con Playwright real) **· D5 ✅** (el tour, `backend-server/public/landing/demo/index.html` — [`demo-guion.md` §13](demo-guion.md#13-d5-ejecutado-2026-08-27--el-tour-publicado-en-backend-serverpubliclandingdemo)) **· D6 implementado, falta desplegar** (navbar + hero + tarjetas de la landing, gate de sesión en `/demo/`, entradas nuevas en el portal — alcance ampliado a pedido del operador, [`demo-guion.md` §14](demo-guion.md#14-d6-implementado-2026-08-27--integración-en-landing--portal-con-gate-para-clientes)) · sigue **D4** (capturas manuales del operador) y **el despliegue de D6** |
