...
```
  ...
  (lo que se muestra y se vende)           │  AZ — Azure Trusted Signing     │
    ...
    1.6 Demo reproducible en landing   🔄  (D1 guion ✅, D2 fixtures ✅, sigue D3)
              │
              ▼
...
### 1.6 — Demo reproducible del producto en la landing ⏳ D1+D2 EJECUTADAS, EN CURSO
...
| **Fases** | **6 (D1–D6)** · **D1 ✅ · D2 ✅** (fixtures + generador + capa de sustitución, verificados con Playwright — [`demo-guion.md` §11](demo-guion.md#11-d2-ejecutado-2026-08-27--fixtures--capa-de-sustitución-verificados)) · sigue **D3** (pipeline de captura automatizada) |
