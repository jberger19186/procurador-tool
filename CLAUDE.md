...
> 3. **`docs/internal/plan-pruebas-integral-2026-07.md`** — BLOQUE R (37 casos) con spec de automatización (22 AUTO/9 SEMI/6 OP, 4 tandas) + tabla de modelo/esfuerzo por etapa + regla: si el ejecutor quiere cambiar de modelo, **informa y espera confirmación del operador antes de seguir**.
>
