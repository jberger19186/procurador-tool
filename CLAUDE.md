...
> 6. ⭐ **`docs/internal/plan-Q6-verificacion-firmas-2026-07-28.md`** — cierra los **9 fail-opens** del sistema de verificación de firmas de scripts. **✅ Fase 1 (backend, C1/F9) EN PRODUCCIÓN** (2026-07-29, commit `8d01090`) · **✅ Fase 2 (cliente, C2-C6) EN PRODUCCIÓN — release `electron-v2.7.45` publicado y confirmado en vivo** (2026-07-30, commits `e080809`/`73923e9`/`7fe2522`) — los 5 fail-opens de `authManager.js` cerrados, verificados con 19/19 aserciones automatizadas + los 3 flujos reales contra el PJN corridos por el operador con el código ya endurecido, sin fallar ninguno. **Cero cambios en `src/security/`** en toda la Fase 2 (zona protegida). El release también incluye 4 fixes ajenos a Q6 (ver la entrada de sesión de arriba). **Para continuar:** dejar correr el v2.7.45 unos días antes de la **Fase 3** (etapa 3 real, C7/F6, release v2.7.46 — la más delicada de las tres, toca el camino crítico de cada ejecución) → sesión nueva, Sonnet ALTO → «Ejecutá la Fase 3 del plan `docs/internal/plan-Q6-verificacion-firmas-2026-07-28.md`».
>
