...
> Versión extensión Chrome: código en **1.3.6** (commit `d208fe0`) — **subida al dashboard de Chrome Web Store por el operador el 2026-07-25, ⏳ en revisión de Google.** El store todavía sirve 1.3.5 hasta que se apruebe. Verificar al retomar: `curl -s https://chromewebstore.google.com/detail/aodnfemklhciagaglpggnclmbdhnhbme` (o abrir la ficha) y actualizar esta línea cuando el store pase a mostrar 1.3.6.
