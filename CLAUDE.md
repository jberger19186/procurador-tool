...
> 5. ⭐ **`docs/internal/plan-correcciones-E1-E6-2026-07-27.md`** — **el trabajo más accionable, EN EJECUCIÓN.** Plan de los ~35 hallazgos de E1-E6, organizado por vector de despliegue: ~~**Bloque A** backend+dashboard~~ ✅ **HECHO (2026-07-28, commit `03e294d`) — P-1 cerrado, sin pendientes** · **Bloque B** base de datos (regenerar `schema.sql` + índices) · **Bloque C** motor Puppeteer (reencrypt, sin release de Electron, el de mayor valor) · **Bloque D** release de Electron (incluye el fix de P-2) · ~~**Bloque E** extensión~~ ✅ **CÓDIGO LISTO (2026-07-28, commit `1f9d1c4`), v1.3.7 — ⏳ falta que el operador suba el ZIP al Chrome Web Store**. **Q1/Q2/Q3/Q5 ya resueltas**; quedan **Q4/Q6/Q7**. **Próximo recomendado: Bloque B** (corto, cierra el drift de schema), luego **Bloque C** cuando haya ventana con el operador para la verificación contra el PJN. **Para retomar:** sesión nueva → «Ejecutá el Bloque [letra] del plan `docs/internal/plan-correcciones-E1-E6-2026-07-27.md`».
>
