...
> 5. ⭐ **`docs/internal/plan-correcciones-E1-E6-2026-07-27.md`** — **el trabajo más accionable, EN EJECUCIÓN.** Plan de los ~35 hallazgos de E1-E6, organizado por vector de despliegue: **Bloque A** backend+dashboard (sin release) · **Bloque B** base de datos (regenerar `schema.sql` + índices) · **Bloque C** motor Puppeteer (reencrypt, sin release de Electron, el de mayor valor) · **Bloque D** release de Electron (incluye el fix de P-2) · **Bloque E** extensión (fix del logo con SSO decidido). **Q1/Q2/Q5 ya resueltas** (2026-07-27: logo con SSO automático, se descartó el ítem de jurisdicción, schema.sql se automatiza en el backup diario); quedan Q3/Q4/Q6/Q7. **Para retomar:** sesión nueva → «Ejecutá el Bloque [letra] del plan `docs/internal/plan-correcciones-E1-E6-2026-07-27.md`».
>
