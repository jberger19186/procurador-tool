...
> 🧪 **Flecos del plan de pruebas integral (2026-07-03/04, revisados 2026-07-14):** `docs/internal/plan-pruebas-integral-2026-07.md` — sección "Hallazgos" (los 4 ya corregidos, ver historial) y casos con ⚠️ PASS parcial / ⏭️ SKIP sin resolver: **U9.3** (pagar una reactivación, bloqueado por causa no identificada — el único bug real de la lista, requiere E2E con MP sandbox en su propia sesión), A1.14 (ciclo completo de reset de contraseña), A7.5 (rate limit del bot IA, no ejecutado por costo), A2.6/A2.8, A4.4/A4.5, A3.10/A3.11, U5.3, U11.7 (confirmaciones visuales pendientes, no bugs — mayoría bajo riesgo, no priorizadas). **Consultar ese doc si preguntan por el estado de las pruebas o pendientes de QA.**
