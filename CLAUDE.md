...
## 🔄 Estado actual
> Versión app Electron: **2.7.39** — publicada en GitHub Releases (auto-updater activo)
...
> ⭐⭐ **REGLA (2026-07-19): cuando el usuario pida "los pendientes", SIEMPRE mencionar estos 3 documentos como trabajo listo para ejecutar** (los tres fueron revisados y corregidos en 2ª pasada el 2026-07-19 — verificados contra el código real para que su ejecución no falle; cada uno indica modelo Sonnet/Opus y nivel de esfuerzo por fase/etapa):
> 1. **`docs/internal/revision-integral-2026-07-19.md`** — 5 hallazgos Baja severidad (RI-1 multer 500→400 · RI-2 cap del bot IA con shapes distintos por endpoint · RI-3 rate-limit routers · RI-4 limpieza CRX en 4 fases, requiere release Electron primero · RI-5 logout del portal sin blacklist) con solución autosuficiente + fases + modelo/esfuerzo cada uno.
